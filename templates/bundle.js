...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExampleComponent = function (_Component) {
	    ...
	    _createClass(ExampleComponent, [{
	        key: "getComponentUrl",
	        value: function getComponentUrl() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templateDefinitions = __webpack_require__(5);
	...
	var Template = exports.Template = function () {
	    ...
	    _createClass(Template, [{
	        ...
	        key: "render",
	        value: function render(selector, data) {

	            _api.API.get(this.getTemplateUrl(), function (html) {

	                var parser = new DOMParser();
	                var doc = parser.parseFromString(html, "text/html");

	                var templateEngine = new _templateEngine.TemplateEngine();
...
/***/ function(module, exports, __webpack_require__) {
	...
	function includeData(element, doc, engine, selector, data) {
	...
	function injectData(element, doc, engine, selector, data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.TemplateEngine = undefined;
	...
	var TemplateEngine = exports.TemplateEngine = function () {
	    function TemplateEngine() {
	        _classCallCheck(this, TemplateEngine);

	        this.handlers = {
	            "data-bind": _templateDefinitions.injectData,
	            "data-include": _templateDefinitions.includeData
	        };
	    }

	    _createClass(TemplateEngine, [{
	        key: "traverse",
	        value: function traverse(element, doc, engine, selector, data) {

	            Object.keys(this.handlers).forEach(function (key) {
	                if (element instanceof HTMLElement && element.hasAttribute(key)) this.handlers[key](element, doc, engine, selector, data);

	                (0, _jquery2.default)(selector).html(doc.documentElement.innerHTML);
	            }.bind(this));
	...
	var Component = exports.Component = function () {
	    ...
	    _createClass(Component, [{
	        ...
	        value: function load(callback) {
	            ...
	            _api.API.get(this.getComponentUrl(), callback, 'html');
	        }
	    }]);
