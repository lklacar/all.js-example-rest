...
/***/ function(module, exports, __webpack_require__) {
	...
	/*
	 for (var i = 0; i < 10; i++) {
	 var post = new Post();
	 post.text = i.toString();
	 post.save();
	 }


	 Post.all(function (array) {
	 console.log(array);
	 });


	 var id = 5;
	 Post.get(id, function (post) {
	 console.log(post);
	 });*/
	...
	var ExampleTemplate = function (_Template) {
	    ...
	    _createClass(ExampleTemplate, null, [{
	        ...
	        value: function getTemplateUrl() {
	            return "http://localhost:8000/template/template";
	        }
	    }]);
	        ...
	        value: function render(tag) {
	            ...
	            _jquery2.default.ajax({
	                ...
	                success: function success(data) {
	                    (0, _jquery2.default)(tag).html(data);
	                },
	                error: function error(xhr, status, _error) {},
	                dataType: "html"
	            });
